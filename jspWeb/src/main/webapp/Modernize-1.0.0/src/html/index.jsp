            ...
            <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                ...
                <span>
                  <i class="ti ti-layout-dashboard"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="./index.jsp?page=newitem" aria-expanded="false">
                <span>
                  <i class="ti ti-article"></i>
                </span>
                            <span class="hide-menu">NewItem</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                ...
                <span>
                  <i class="ti ti-file-description"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="https://ai-poet-seon.streamlit.app/" aria-expanded="false">
                <span>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up"
                                ...
                                <div class="message-body">
                                    ...
                                    <a href="./infoView.jsp" class="d-flex align-items-center gap-2 dropdown-item">
                        ...
                        <div class="card-body">
                            <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                                <div class="mb-3 mb-sm-0">
                                    <h5 class="card-title fw-semibold">Reading Overview</h5>
                                </div>
                                <div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row alig n-items-start">
                                        <div class="col-8">
                                            <h5 class="card-title mb-9 fw-semibold"> Monthly Reading </h5>
            ...
            <div class="row">
                <div class="col-lg-4 d-flex align-items-stretch">
                    <div class="card w-100">
                        <div class="card-body p-4">
                            <div class="mb-4">
                                <h5 class="card-title fw-semibold">Recent ReadingTime</h5>
                            </div>
